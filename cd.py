...
window_title   = f"WARP-PLUS-CLOUDFLARE By IGGIE (version {script_version})"
...
print ("--------")
print ("[+] THIS SCRIPT CODDED BY IGGIE") 
print ("[-] SITE: https://t.me/Modzilla") 
print ("[-] TELEGRAM: Iggie")
print ("--------")
...
while True:
	os.system('cls' if os.name == 'nt' else 'clear')
	print("")
	print("      WARP-PLUS-CLOUDFLARE (script)" + " By IGGIE")
	print("")
